...
const fetchPurpose = async () => {
  ...
  try {
    const { data } = await api.get(`/project/life_cycle/${lifeCycle.value.id}/define_purpose`)
    if (data) {
...
const savePurpose = async () => {
  ...
  try {
    ...
    await api.put(`/project/life_cycle/${lifeCycle.value.id}/define_purpose`, payload)
